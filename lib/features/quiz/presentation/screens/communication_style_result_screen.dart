// lib/features/quiz/presentation/screens/communication_style_result_screen.dart
...
class CommunicationStyleResultScreen extends ConsumerStatefulWidget {
  final CommunicationStyleResult result;

  const CommunicationStyleResultScreen({super.key, required this.result});

  @override
  ConsumerState<CommunicationStyleResultScreen> createState() =>
      _CommunicationStyleResultScreenState();
}

class _CommunicationStyleResultScreenState
    extends ConsumerState<CommunicationStyleResultScreen>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Your communication snapshot'),
        centerTitle: true,
          ...
          child: FadeTransition(
            ...
            child: Column(
              ...
              children: [
                ...
                Gap(Spacing.xl.h),
                // Spectrum bars (independent 0-100)
                Text(
                  'Your spectrum',
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          'This reflects how you answered today. Communication can change with context, safety, culture, and relationship dynamics.',
