...
void main() {
  ...
  test('light chat palette carries the cool-mint conversation treatment', () {
    ...
    // Dark keeps its own green rather than the light blue: tried and
    // reverted, the blue read worse against the dark bubble. Pinned so the
    // divergence is deliberate rather than drift.
    expect(ChatColorScheme.dark.voiceAccent, const Color(0xFFB6FD9D));
  });
}
