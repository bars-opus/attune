...
} NS_SWIFT_NAME(TileStoreUsageMode) __attribute__((deprecated));

NSString* MBMTileStoreUsageModeToString(MBMTileStoreUsageMode tile_store_usage_mode) __attribute__((deprecated));
